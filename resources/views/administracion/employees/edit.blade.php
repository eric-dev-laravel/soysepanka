                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input type="date" class="form-control" id="nacimiento" name="nacimiento" value="{{ $info_employee[0]->nacimiento }}" placeholder="{!! trans('message.form_employee_holder.birth') !!}">
                                        </div>
                                    </div>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input type="date" class="form-control" id="ingreso" name="ingreso" value="{{ $info_employee[0]->ingreso }}" placeholder="{!! trans('message.form_employee_holder.entry') !!}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input type="date" class="form-control" id="fechapuesto" name="fechapuesto" value="{{ $info_employee[0]->fechapuesto }}" placeholder="{!! trans('message.form_employee_holder.date_position') !!}">
                                        </div>
                                    </div>
