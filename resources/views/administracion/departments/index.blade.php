	...
	<div class="container-fluid spark-screen">
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">{{ trans('message.ma.admin_all_departments') }}</span>
                        <span class="info-box-number">{{ $departments_data['all_departments'] }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">{{ trans('message.ma.admin_active_departments') }}</span>
                        <span class="info-box-number">{{ $departments_data['active_departments'] }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">{{ trans('message.ma.admin_inactive_departments') }}</span>
                        <span class="info-box-number">{{ $departments_data['inactive_departments'] }}</span>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="box box-info box-solid">
                                    ...
                                    <div class="box-body">
                                        <div class="row col-md-3 col-sm-12 col-md-offset-1">
                                            <button type="button" onclick="window.location.href = '{{ url('admin-departments/create') }}';" class="btn btn-block btn-info"><i class="fa fa-briefcase"></i> {{ trans('message.newdepartment') }}</button>
                                        </div>
                                    </div>
        ...
        <div class="row">
			<div class="col-md-12">
				...
				<div class="box">
					<div class="box-header with-border">
						<h3 class="box-title"><i class="fa fa-briefcase"></i> {{ trans('message.ma.admin_list_departments') }}</h3>
