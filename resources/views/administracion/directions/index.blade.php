	...
	<div class="container-fluid spark-screen">
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box">
                    <span class="info-box-icon bg-aqua"><i class="fa fa-arrows"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text">{{ trans('message.ma.admin_all_directions') }}</span>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">{{ trans('message.ma.admin_active_directions') }}</span>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">{{ trans('message.ma.admin_inactive_directions') }}</span>
                                ...
                                <div class="box box-info box-solid">
                                    ...
                                    <div class="box-body">
                                        <div class="row col-md-3 col-sm-12 col-md-offset-1">
                                            <button type="button" onclick="window.location.href = '{{ url('admin-directions/create') }}';" class="btn btn-block btn-info"><i class="fa fa-arrows"></i> {{ trans('message.newdirection') }}</button>
                                        </div>
                                    </div>
        ...
        <div class="row">
			<div class="col-md-8">
				...
				<div class="box">
					<div class="box-header with-border">
						<h3 class="box-title"><i class="fa fa-arrows"></i> {{ trans('message.ma.admin_list_directions') }}</h3>
