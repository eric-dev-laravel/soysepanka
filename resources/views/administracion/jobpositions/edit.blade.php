...
@section('main-content')
            ...
            <div class="box box-primary box-solid">
                ...
                <div class="box-body">
                    ...
                    <div class="row col-md-3 col-sm-12 col-md-offset-1">
                        @if($info_direction['jobposition'][0]->deleted_at)
    ...
    <div class="row">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row col-md-12">
                        <form role="form" method="POST" action="{{ route('admin-jobpositions.update',$info_direction['jobposition'][0]->id) }}" id="update">
                            {!! method_field('PUT') !!}
                            {!! csrf_field() !!}
        ...
        <div class="modal modal-danger fade" id="modal-unactive-employee" style="display: none;">
            <form class="form" action="{{ route('admin-jobpositions.destroy' , $info_direction['jobposition'][0]->id)}}" method="POST">
                {!! method_field('DELETE') !!}
                {!! csrf_field() !!}
                <div class="modal-dialog">
                    <div class="modal-content">
        ...
        <div class="modal modal-success fade" id="modal-active-employee" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">{{ trans('message.buttons.close') }}</button>
                            <button type="button" onclick="window.location.href = '{{ url('active-jobposition/'.$info_direction['jobposition'][0]->id.'') }}';" class="btn btn-outline">{{ trans('message.buttons.active') }}</button>
                        </div>
                    </div>
                </div>
        </div>
