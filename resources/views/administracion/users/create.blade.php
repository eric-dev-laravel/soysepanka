                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group has-feedback col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="password" required class="form-control" placeholder="{{ trans('message.form_employee_holder.password') }}" name="password" id="password"/>
                                    ...
                                    <div class="form-group has-feedback col-md-4">
                                        <label for="password">{{ trans('message.datatables_headers.password') }}</label>
                                        <div class="input-group">
                                            <input type="password" required class="form-control" placeholder="{{ trans('message.form_employee_holder.retrypassword') }}" name="password_confirmation" id="password_confirmation"/>
                                            <span class="input-group-btn">
