    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="alert alert-danger alert-dismissible">
                ...
                <h4><i class="icon fa fa-bookmark-o"></i> {{ trans('message.modals.alert') }}</h4>
            ...
            <div class="box box-primary box-solid">
                ...
                <div class="box-body">
                    ...
                    <div class="row col-md-3 col-sm-12 col-md-offset-1">
                        @if($info_direction['direction'][0]->deleted_at)
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-bookmark-o"></i> {{ trans('message.editdirection') }}</h3>
                ...
                <div class="box-body">
                    <div class="row col-md-12">
                        <form role="form" method="POST" action="{{ route('admin-marks.update',$info_direction['direction'][0]->id) }}" id="update">
                            {!! method_field('PUT') !!}
                            {!! csrf_field() !!}
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-header with-border">
                                    <h3 class="box-title"><i class="fa fa-pencil"></i> {{ trans('message.info_createmarks') }}</h3>
                                </div>

                                <div class="box-body">

                                    <div class="form-group col-md-6">
                                        <label for="id_enterprise">{{ trans('message.datatables_headers.enterprise_id') }}</label>
                                        <select class="form-control" id="id_enterprise" name="id_enterprise">
                                            <option value="">Sin empresa</option>
                                            @foreach ($info_direction['enterprises'] as $enterprises)
                                                @if($enterprises->id == $info_direction['direction'][0]->id_enterprise)
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" required class="form-control" id="name" name="name" value="{{ $info_direction['direction'][0]->name }}" placeholder="{{ trans('message.form_employee_holder.mark') }}">
                                    </div>
                                ...
                                <div class="box-footer">
                                    <div class="row col-md-1 col-sm-12">
                                        <button type="button" onclick="window.location.href = '{{ url('admin-marks') }}';" class="btn btn-primary"><i class="fa fa-arrow-left"></i> {{ trans('message.buttons.back') }}</button>
                                    </div>
                                    ...
                                    <div class="row col-md-1 col-sm-12 col-md-offset-1">
                                        <button type="button" onclick="window.location.href = '{{ url('admin-marks') }}';" class="btn btn-danger"><i class="fa fa-ban"></i> {{ trans('message.buttons.cancel') }}</button>
                                    </div>
                                </div>
        ...
        <div class="modal modal-danger fade" id="modal-unactive-employee" style="display: none;">
            <form class="form" action="{{ route('admin-marks.destroy' , $info_direction['direction'][0]->id)}}" method="POST">
                {!! method_field('DELETE') !!}
                {!! csrf_field() !!}
                <div class="modal-dialog">
                    <div class="modal-content">
        ...
        <div class="modal modal-success fade" id="modal-active-employee" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">{{ trans('message.buttons.close') }}</button>
                            <button type="button" onclick="window.location.href = '{{ url('active-mark/'.$info_direction['direction'][0]->id.'') }}';" class="btn btn-outline">{{ trans('message.buttons.active') }}</button>
                        </div>
                    </div>
                </div>
        </div>
