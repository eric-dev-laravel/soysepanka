                    ...
                    <div class="box-body">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item active">
                                <img src="{{ asset('img/comunicacionInterna/banner_infografico.png') }}" alt="First slide">
                ...
                <div class="box box-solid">
                    <div class="box-body">
                        ...
                        <div class="col-md-4">
                            ...
                            <img class="img-responsive pad col-md-12" src="{{ asset('img/comunicacionInterna/info2.jpg') }}" alt="Photo">
                        ...
                        <div class="col-md-4">
                            ...
                            <img class="img-responsive pad col-md-12" src="{{ asset('img/comunicacionInterna/info3.jpg') }}" alt="Photo">
