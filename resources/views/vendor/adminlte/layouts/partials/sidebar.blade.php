            ...
            <div class="user-panel">
                <div class="pull-left image">
                    @if (empty($user->picture))
                        <img class="img-circle" src="{{ asset('img/record/user.png') }}" alt="User Avatar">
                    @else
                        <img class="img-circle" src="{{ asset($user->url_path) }}" alt="User Avatar">
                    @endif
                </div>
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ url('admin-jobpositionscatalog') }}"><i class='fa fa-book'></i> {{ trans('message.ma.jobpositioncatalog') }}</a></li>
            ...
            <li class="treeview">
                <a href="#"><i class='fa fa-wrench'></i> <span>{{ trans('message.module9') }}</span> <i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                    <li><a href="#">{{ trans('message.linklevel2') }}</a></li>
                </ul>
            </li>
